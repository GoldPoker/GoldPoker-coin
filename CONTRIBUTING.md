Contributing to Gold Poker Core
==================================

The Gold Poker Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Gold Poker Core project, and is not to be
confused with overall Gpkr Network Protocol consensus changes.

Whether a pull request is merged into Gold Poker Core rests with the project merge
...
Patches that change Gpkr consensus rules are considerably more involved than
...
Where a patch set proposes to change the Gpkr consensus, it must have been
...
The project leader is the release manager for each Gold Poker Core release.
