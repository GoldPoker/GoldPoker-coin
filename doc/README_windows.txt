...
Intro
-----
Gpkr (GPKR) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. Gpkr utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run gpkr-qt.exe.

Gold Poker Core is the original Gpkr client and it builds the backbone of the network.
However, it downloads and stores the entire history of Gpkr transactions;
