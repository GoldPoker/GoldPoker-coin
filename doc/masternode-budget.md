...
Gpkr now supports full decentralized budgets that are paid directly from the blockchain via superblocks once per month.
...
mnbudget prepare \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<gpkr_address\> \<monthly_payment_gpkr\> [use_ix(true|false)]
...
In this transaction we prepare collateral for "_cool-project_". This proposal will pay _1200_ GPKR, _12_ times over the course of a year totaling _24000_ GPKR.
...
mnbudget submit \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<gpkr_address\> \<monthly_payment_gpkr\> \<collateral_hash\>
...
When block `1000000` is reached you'll receive a payment for `1200` GPKR.
