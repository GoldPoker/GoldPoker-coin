...
RESOURCES += src/qt/gpkr.qrc src/qt/gpkr_locale.qrc

TRANSLATIONS += src/qt/locale/gpkr_bg.ts \
                src/qt/locale/gpkr_de.ts \
                src/qt/locale/gpkr_en.ts \
                src/qt/locale/gpkr_es.ts \
                src/qt/locale/gpkr_fi.ts \
                src/qt/locale/gpkr_fr.ts \
                src/qt/locale/gpkr_it.ts \
                src/qt/locale/gpkr_ja.ts \
                src/qt/locale/gpkr_pl.ts \
                src/qt/locale/gpkr_pt.ts \
                src/qt/locale/gpkr_ru.ts \
                src/qt/locale/gpkr_sk.ts \
                src/qt/locale/gpkr_sv.ts \
                src/qt/locale/gpkr_vi.ts \
                src/qt/locale/gpkr_zh_CN.ts \
                src/qt/locale/gpkr_zh_TW.ts
