...
#   c) node1 mines 32 blocks, so now node 0 has 500000GPKR, node 1 has 4250GPKR, node2 has none.
#   d) node0 sends 601 GPKR to node2, in two transactions (301 GPKR, then 300 GPKR).
