...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Gold Poker Core gpkr-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  gpkr-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded gpkr transaction") + "\n" +
                               "  gpkr-tx [options] -create [commands]   " + _("Create hex-encoded gpkr transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded gpkr transaction
