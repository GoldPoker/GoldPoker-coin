...
/**
 * Fees smaller than this (in ugpkr) are considered zero fee (for transaction creation)
            ...
            while (true) {
                ...
                if (!SelectCoins(nTotalValue, setCoins, nValueIn, coinControl, coin_type, useIX)) {
                    if (coin_type == ALL_COINS) {
                        ...
                        strFailReason = _("Unable to locate enough funds for this transaction that are not equal 33333 GPKR.");
                    }
                ...
                if (nChange > 0) {
                    ...
                    // change transaction isn't always pay-to-gpkr-address
                    CScript scriptChange;
